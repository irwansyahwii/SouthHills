...
(function() {
  var BUTTON_HEIGHT, BUTTON_POS_Y, BUTTON_WIDTH, DayViewScreen, FloorplanScreen, HighZoneScreen, LowZoneScreen, NorthViewScreen, SCREEN_HEIGHT, SitePlanScreen,
  ...
  FloorplanScreen = (function() {
    function FloorplanScreen() {
      ...
      this.showDayViewScreen = bind(this.showDayViewScreen, this);
    ...
    FloorplanScreen.prototype.showDayViewScreen = function(e) {
      var button, dayViewScreen, height, imageName, width;
      imageName = "";
      button = e;
      ...
      return this.assignToCurrentSubscreen(dayViewScreen);
    };

    FloorplanScreen.prototype.showHighZoneScreen = function() {
      var highZoneScreen;
      highZoneScreen = new HighZoneScreen().init();
      highZoneScreen.onDayViewClicked = (function(_this) {
        return function(e) {
          return _this.showDayViewScreen(e);
        };
      })(this);
    ...
    FloorplanScreen.prototype.showLowZoneScreen = function() {
      ...
      lowZoneScreen.onDayViewClicked = (function(_this) {
        return function(e) {
          return _this.showDayViewScreen(e);
        };
      })(this);
